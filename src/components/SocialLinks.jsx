...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/saint-michel-linus-nto-6ab686335",
    color: "#0A66C2",
  ...
  },
  {
    ...
    icon: ExternalLink,
    url: "https://michelcorp.github.io/My_Portfolio/",
    color: "#6366f1",
  ...
  },
  {
    ...
    subText: "@michelcorp",
    icon: Github,
    url: "https://github.com/michelcorp",
    color: "#ffffff",
...
const SocialLinks = () => {
  ...
  const [portfolio, github] = otherLinks;
  ...
  return (
    <div className="w-full bg-gradient-to-br from-white/10 to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl">
      ...
      <div className="flex flex-col gap-4">
        ...
        {/* Second Row - Portfolio & GitHub */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[portfolio, github].map((link, index) => (
            <a
              key={link.name}
              href={link.url}
              target="_blank"
