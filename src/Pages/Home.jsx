...
const WORDS = ["Mechanical and Computational Engineering Student", "AI/ML Enthusiast"];
const TECH_STACK = ["Python", "ANSYS", "SolidWorks", "MATLAB", "C/C++", "Java", "Labview", "SQL", "Arduino"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/michelcorp" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/saint-michel-linus-nto-6ab686335" },
  { icon: ExternalLink, link: "https://michelcorp.github.io/My_Portfolio/" }
];
